...
Age   Description
----- -----------------------------------------------------------------------
 6d   write how I use track and graph
11w   code quantum calculator
 2w   code music scale
 2w   write a list of favourite works
11d   code fix qr code browser block bug
 2d   write distinguish advice and chicken soup
 2d   write how to form values and what to believe
...
11d   search how to set default key press rate
11d   find lua script for statistics
...
11d   write update ai music
 ...
 3w   fix blog snippet bug when not specify type
