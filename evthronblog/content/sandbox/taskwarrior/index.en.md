...
----- --------------------------------------------------------------------------
 3w   make resume
 9w   watch job brief
10d   draw new blog background from postcard
10d   redraw ai-generated-image
10d   write about privacy anonymity
 3mo  write language compare code article
11w   add a link page to my blog
10d   code task warrior hook for motivational quote
10d   buy a domain
10d   write categorization and filetags
 9d   write math reinvention and my story of factorization
...
10d   write how a make the painter progress bar
12d   code tic-tac-toe on blog
10d   write fake creation and real idea
 3mo  incremental video in obsidian
10d   code step count chart
...
11d   write reason to draw
 ...
 6d   write introduction to toki pona
 6d   write update docker nftables
 6d   watch krita tutorial
 6d   write passion to music
 6d   write update post overnight, tired of it
 5d   write tweet terminal to gui gap
