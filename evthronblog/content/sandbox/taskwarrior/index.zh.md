...
lastmod: 2026-06-11T05:58:10+08:00
image: 
categories: 
tags: 
math: true
...
{{< task title="write past paper overfitting analogy" note="1.1y" >}}
{{< task title="write how to solve a math problem together" note="1.0y" >}}
{{< task title="find what is kwin" note="9mo" >}}
{{< task title="write sleep theory" note="9mo" >}}
...
{{< task title="code add sync to pedometer" note="5mo" >}}
{{< task title="find out why food order menu cannot load" note="1.0y" >}}
{{< task title="write tutorial to set default mime type open with" note="9mo" >}}
{{< task title="add a link page to my blog" note="1.6y" >}}
...
{{< task title="write how exam twist peopls's mind" note="5mo" >}}
{{< task title="write useless productivity skill" note="1.3y" >}}
{{< task title="write how a make the painter progress bar" note="1.4y" >}}
{{< task title="code learn how to store chatbot history in streamlit" note="1.1y" >}}
{{< task title="redraw ai-generated-image" note="1.4y" >}}
...
{{< task title="set up local habitica server" note="1.6y" >}}
{{< task title="awesomewm touchpad fix" note="1.3y" >}}
{{< task title="code direct post chatbot history.monthly" note="6w" >}}
51 tasks