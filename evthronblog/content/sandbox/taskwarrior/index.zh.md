...
我的待辦清單，想到什麼就加進去。
{{< task title="write internship reflection" note="6mo" >}}
{{< task title="find one interesting physics concept to explain without math" note="10mo" >}}
{{< task title="search for games related to maths" note="10mo" >}}
{{< task title="solve convolve output edge size by cardinal theory" note="10mo" >}}
{{< task title="write past paper overfitting analogy" note="10mo" >}}
{{< task title="write how to solve a math problem together" note="10mo" >}}
{{< task title="find what is kwin" note="7mo" >}}
{{< task title="write sleep theory" note="7mo" >}}
{{< task title="write null check and complexity" note="6mo" >}}
{{< task title="investigate roam research" note="6mo" >}}
{{< task title="code fix qr only browser" note="6mo" >}}
{{< task title="find syntax highlighter for english" note="4mo" >}}
{{< task title="fix libinput orientation of tablet" note="3mo" >}}
{{< task title="write university problem of common space and study group" note="1.3y" >}}
{{< task title="sketch blog library UI" note="11mo" >}}
...
{{< task title="write how a make the painter progress bar" note="1.2y" >}}
{{< task title="code learn how to store chatbot history in streamlit" note="10mo" >}}
{{< task title="redraw ai-generated-image" note="1.2y" >}}
{{< task title="write why I dislike travelling" note="11mo" >}}
{{< task title="automate blog pubilication" note="6mo" >}}
{{< task title="add japanese as blog language" note="1.1y" >}}
